...
#define NEXUS_LOG_TRACE(logger, message) NEXUS_LOG_IMPL(logger, ::nexus::core::LogLevel::Trace, message)
#define NEXUS_LOG_DEBUG(logger, message) NEXUS_LOG_IMPL(logger, ::nexus::core::LogLevel::Debug, message)
#define NEXUS_LOG_INFO(logger, message) NEXUS_LOG_IMPL(logger, ::nexus::core::LogLevel::Info, message)
#define NEXUS_LOG_WARN(logger, message) NEXUS_LOG_IMPL(logger, ::nexus::core::LogLevel::Warn, message)
#define NEXUS_LOG_ERROR(logger, message) NEXUS_LOG_IMPL(logger, ::nexus::core::LogLevel::Error, message)
#define NEXUS_LOG_CRITICAL(logger, message) NEXUS_LOG_IMPL(logger, ::nexus::core::LogLevel::Critical, message)
